...
KNOWN: List[Dict[str, Any]] = [
    ...
    {"name": "TOC_SUBJECT_INDICATORS", "label": "Subject indicators", "group": "sections", "secret": False, "needed_by": [],    "help": "What S2 rates a person of concern on: a comma list of labels (or id=Label). Blank means the profile's default list. No instrument is implemented and nothing is scored (\u00a75.6b)."},
