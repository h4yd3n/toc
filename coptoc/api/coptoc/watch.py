...
LOG_BUCKETS = {
    ...
    "cop.ccir.written": "posture", "cop.ccir.tripped": "posture", "cop.ccir.cleared": "posture",   # §3.6 — a CCIR trip is a command event, briefed with posture
    "cop.exercise.created": "operations", "cop.exercise.startex": "operations", "cop.exercise.endex": "operations", "cop.exercise.inject": "operations",   # §3.7 — an exercise is the watch's business, and its log is the AAR's evidence
